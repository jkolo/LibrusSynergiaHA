...
const _t = (r) => new lt(typeof r == "string" ? r : r + "", void 0, J), $t = (r, ...t) => {
...
x.elementStyles = [], x.shadowRootOptions = { mode: "open" }, x[P("elementProperties")] = /* @__PURE__ */ new Map(), x[P("finalized")] = /* @__PURE__ */ new Map(), I == null || I({ ReactiveElement: x }), (g.reactiveElementVersions ?? (g.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const Pt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let d, p, l = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === C ? p[1] === "!--" ? o = it : p[1] !== void 0 ? o = rt : p[2] !== void 0 ? (pt.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = m) : p[3] !== void 0 && (o = m) : o === m ? p[0] === ">" ? (o = i ?? C, l = -1) : p[1] === void 0 ? l = -2 : (l = o.lastIndex - p[2].length, d = p[1], o = p[3] === void 0 ? m : p[3] === '"' ? ot : nt) : o === ot || o === nt ? o = m : o === it || o === rt ? o = C : (o = m, i = void 0);
    const _ = o === m && r[a + 1].startsWith("/>") ? " " : "";
    n += o === C ? h + xt : l >= 0 ? (s.push(d), h.slice(0, l) + ct + h.slice(l) + $ + _) : h + $ + (l === -2 ? a : _);
  }
...
class N {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    if (this.el = N.createElement(d, s), y.currentNode = this.el.content, e === 2 || e === 3) {
...
class H {
  ...
  _$AI(t, e = this) {
    t = S(this, t, e), T(t) ? t === c || t == null || t === "" ? (this._$AH !== c && this._$AR(), this._$AH = c) : t !== this._$AH && t !== b && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : St(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class j {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (n === void 0) t = S(this, t, e, 0), o = !T(t) || t !== this._$AH && t !== b, o && (this._$AH = t);
    else {
      const a = t;
      let h, d;
      for (t = n[0], h = 0; h < n.length - 1; h++) d = S(this, a[s + h], e, h), d === b && (d = this._$AH[h]), o || (o = !T(d) || d !== this._$AH[h]), d === c ? t = c : t !== c && (t += (d ?? "") + n[h + 1]), this._$AH[h] = d;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
var ht;
O._$litElement$ = !0, O.finalized = !0, (ht = v.litElementHydrateSupport) == null || ht.call(v, { LitElement: O });
...
let f = class extends O {
  ...
  render() {
    ...
    const r = this._messages, t = this._config.title ?? "Wiadomości Librus";
    return w`
      <ha-card>
      ...
      this._onlyUnread = e.target.checked;
        ...
        <div class="message-list">
          ${r.length === 0 ? w`<div class="empty">Brak wiadomości</div>` : r.map((e) => this._renderMessage(e))}
        </div>
      </ha-card>
    `;
  }
      ...
      <div class="message-item ${r.unread && !r.is_read_in_ha ? "unread" : ""}">
        <div class="message-header">
          <div class="message-meta">
            ...
            <div class="message-title">${r.title}</div>
          </div>
        ...
        ${t ? w`
            <div class="message-content">
              ${this._loading ? w`<div class="loading">Ładowanie…</div>` : this._content ? It(qt(this._content.content ?? "")) : c}
            </div>
          ` : c}
      </div>
    `;
